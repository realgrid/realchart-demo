...
<FiddleLink label="Try Y values" href="https:/jsfiddle.net/gh/get/library/pure/realgrid/realchart-demo/tree/master/guide/yvalues"/>  
```js
const config = {
    series: {
        type: 'bar',
...
candlestick의 경우,
<FiddleLink label="Try Json Array" href="https:/jsfiddle.net/gh/get/library/pure/realgrid/realchart-demo/tree/master/guide/jsonarray"/>  
###### 단일 값 및 값 배열
|형식|설명|
|---|---|
...
<FiddleLink label="Try Chart Data" href="https:/jsfiddle.net/gh/get/library/pure/realgrid/realchart-demo/tree/master/guide/chartData"/>  
...
<FiddleLink label="Try Update Point" href="https:/jsfiddle.net/gh/get/library/pure/realgrid/realchart-demo/tree/master/guide/updatePoint"/>  
```js
const x = 'google';
...
<FiddleLink label="Try Add & Remove" href="https:/jsfiddle.net/gh/get/library/pure/realgrid/realchart-demo/tree/master/guide/addPoint"/>  
```js
const x = getName();
const y = getValue();
