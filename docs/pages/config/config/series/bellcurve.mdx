...
### belowStyle: `SVGStyles | string{:typescript}`
...
### pointsInSigma: `number{:typescript}`
`default: 3`  

### sigmas: `number{:typescript}`
`default: 3`  

### source: `string | number{:typescript}`
