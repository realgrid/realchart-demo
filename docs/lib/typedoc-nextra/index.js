  ...
  parseConfigProperties(name) {
    ...
    if (chart) {
      ...
      return (props == null ? void 0 : props.map((p) => {
        var _a, _b, _c, _d;
        const sep = ((_a = p.dtype) == null ? void 0 : _a.kind) === import_typedoc.ReflectionKind.Class ? "/" : "#";
...
function createDocumentation(options) {
  return __async(this, null, function* () {
    ...
    if (options.configInputPath) {
      config = JSON.parse(yield (0, import_promises.readFile)(options.configInputPath, "utf-8"));
    }
    const doc = {
      custom: {},
      modules: {},
