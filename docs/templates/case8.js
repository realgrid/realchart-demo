export const config = {
  options: {
    ...
    style: { backgroundColor: '#011927' }
  },
  templates: {
    series: {
      pointLabel: { visible: true, position: 'inside', numberFormat: '#.#' }
    }
  },
  title: {
  ...
  legend: { lineGap: 40, itemGap: 4, reversed: true, style: { fill: '#fff' } },
  xAxis: {
    categories: [
      'Entity Level',
      'Manager',
  ...
  yAxis: { visible: false, grid: false, strictMax: 102 },
  series: [
    {
      layout: 'stack',
      children: [
