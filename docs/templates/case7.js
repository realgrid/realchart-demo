export const config = {
  templates: {
    gauge: {
      maxValue: 70,
      label: { style: {}, text: "<t style='fill:gray'>${x}</t>" },
      rim: { style: { fill: 'none' } }
    }
  },
  title: {
  ...
  subtitle: {
    text: '<b>Trips around the sun required</b><br><b>to reach gender parity in</b><br><b>investing roles at each</b><br><b>level</b>, years',
    align: 'right',
    style: { textAlign: 'right', paddingRight: 100 },
    alignBase: 'body'
  },
  body: {
    annotations: [
  ...
  gauge: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          template: 'gauge',
          value: 4,
          valueRim: { style: { fill: 'var(--color-5)' } },
          label: {
