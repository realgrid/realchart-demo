...
/**
 * Puppetear Tests for categoryaxis-var.html
 */
 describe("categoryaxis-var.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/categoryaxis-var.html";
    let browser: Browser;
