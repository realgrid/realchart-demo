...
/**
 * Puppetear Tests for line.html
 */
 describe("line.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/line.html";
    let browser: Browser;
    ...
    it('init', async () => {
        ...
        // await page.screenshot({path: 'out/ss/line.png'});
        page.close();
    });
});
