...
/**
 * Puppetear Tests for errorbar.html
 */
 describe("errorbar.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/errorbar.html";
    let browser: Browser;
    ...
    it('init', async () => {
        ...
        // await page.screenshot({path: 'out/ss/errorbar.png'});
        page.close();
    });
});
