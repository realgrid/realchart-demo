...
test.describe('boxplot-multi.html test', async function () {
	const url = 'e2e-demo/boxplot-multi.html?debug';
	...
	test('init', async ({ page }) => {
		...
		// await page.screenshot({path: 'out/ss/boxplot-multi.png'});
		page.close();
	});
