...
/**
 * Puppeteer Tests for bargroup.html
 */
 describe("bargroup.N.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/bargroup.html";
    let browser: Browser;
    ...
    it('init', async () => {
        ...
        // await page.screenshot({path: 'out/ss/bargroup.png'});
        page.close();
    });
