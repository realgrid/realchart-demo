...
/**
 * Puppeteer Tests for line-negative.html
 */
 describe("line-negative.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/line-negative.html";
    let browser: Browser;
    ...
    it('init', async () => {
        ...
        // await page.screenshot({path: 'out/ss/line-negative.png'});
        page.close();
    });
});
