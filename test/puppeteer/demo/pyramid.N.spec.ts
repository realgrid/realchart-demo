...
/**
 * Puppeteer Tests for pyramid.html
 */
 describe("pyramid.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/pyramid.html";
    let browser: Browser;
    ...
    it('init', async () => {
        ...
        // await page.screenshot({path: 'out/ss/pyramid.png'});
        page.close();
    });
});
