...
/**
 * Puppeteer Tests for trendline.html
 */
 describe("trendline.html test", async function() {

    const url = "http://localhost:6010/realchart/demo/trendline.html";
    let browser: Browser;
    ...
    it('init', async () => {
        ...
        // await page.screenshot({path: 'out/ss/trendline.png'});
        page.close();
    });
});
