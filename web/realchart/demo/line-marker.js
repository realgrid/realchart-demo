...
function setActions(container) {
    ...
    createListBox(container, "Manufacturing.marker.shape", ['', 'circle', 'diamond', 'square', 'triangle', 'itriangle'], function (e) {
        config.series[1].marker.shape = _getValue(e);
        chart.update(config);
    }, '');
    createListBox(container, "radius", ['3', '4', '5', '6', '7', '8', '9'], function (e) {
